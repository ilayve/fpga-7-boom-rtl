...
#   set_location_assignment PIN_G3 -to KEY1 ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to resetN ;# KEY2/BUTTON2 (left button)
   ...
   set_location_assignment PIN_J6 -to run_stopN ;# SW[0]
...
#   set_location_assignment PIN_D2 -to SW[9] ;# SW[9]
   ...
   set_location_assignment PIN_J1 -to sym_out ;# LEDG[0]
